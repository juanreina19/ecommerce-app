...
import { updateAddress } from "../../../../../src/users/services/addressService";
...
export default function EditAddressScreen() {
  ...
  // Recibe los datos de la dirección como JSON string
      ...
      <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} className="flex-1">
        ...
        >
          <View className="px-5 pt-5 pb-10">
            ...
            <Text className="text-white text-2xl font-bold mb-1">Editar dirección</Text>
